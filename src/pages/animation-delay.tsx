...
const AnimationDelay = () => {
  return (
    <div className="flex h-[100vh] w-full items-center justify-center bg-gradient">
      <div className="flex h-20 w-20 items-center justify-center space-x-1 border gradient-outline rounded-lg">
